...
{
    {
        ...
        { "Bow", 10, 1, sf::seconds(0.5f), TexturesID::Weapons, sf::IntRect(0, 0, 192, 64), 12, Projectile::Arrow, {64.f, 64.f} },
        { "Bazooka", 5, 1, sf::seconds(0.5f), TexturesID::Bazooka, sf::IntRect(0, 0, 32, 32), 1, Projectile::Rocket, {64.f, 64.f} },
    }
};
