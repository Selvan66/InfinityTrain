...
Checkbox::Checkbox(Context &context)
    : Button(context), mCheck(context.textures.get(TexturesID::Gui),
                              sf::IntRect(181, 0, 50, 50)),
...
void Checkbox::setSelection(bool isSelect) { mIsSelected = isSelect; }

bool Checkbox::isSelected() const { return mIsSelected; }
