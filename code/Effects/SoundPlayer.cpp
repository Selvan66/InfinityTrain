...
SoundPlayer::SoundPlayer()
    : mSoundBuffer(), mSounds(), ListenerZ(300.f), Attenuation(8.f),
      MinDistance2D(200.f),
      MinDistance3D(
          std::sqrt(SoundPlayer::MinDistance2D * SoundPlayer::MinDistance2D +
                    SoundPlayer::ListenerZ * SoundPlayer::ListenerZ)) {
  loadSounds();
...
void SoundPlayer::setVolume(float volume) { mVolume = volume; }
