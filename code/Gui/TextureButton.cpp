...
TextureButton::TextureButton(
  Context& context)
  : Button(context), mNormalButton(),
    mSelectedButton(), mPressedButton(),
    mButton() {}

void TextureButton::setTextures(
  const sf::Texture& texture,
  sf::IntRect normal,
  sf::IntRect selected,
  sf::IntRect pressed) {
  mNormalButton =
    sf::Sprite(texture, normal);
  mSelectedButton =
    sf::Sprite(texture, selected);
  mPressedButton =
    sf::Sprite(texture, pressed);
  changeTexture(Button::Normal);
}

sf::FloatRect
TextureButton::getGlobalBounds() const {
...
void TextureButton::changeTexture(
