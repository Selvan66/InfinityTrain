...
void StatisticsState::applyGuiFunctions()
{
	...
	State::getGuiComponent<Text>("StartedGamesVar").setString(std::to_string(context.statistics.get(Statistics::StartedGames)));
	State::getGuiComponent<Text>("KilledEnemiesVar").setString(std::to_string(context.statistics.get(Statistics::KilledEnemies)));
	State::getGuiComponent<Text>("FinishedGamesVar").setString(std::to_string(context.statistics.get(Statistics::FinishedGames)));
